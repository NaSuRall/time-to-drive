...
export default function FormulairePersonnalise() {
  ...
  return (
    <form
      ...
      className="flex flex-col w-full max-w-4xl mx-auto pb-12 px-4 sm:px-6"
    >
      {/* Section : Informations personnelles */}
      <h3 className="flex text-2xl md:text-4xl text-white pt-6 pb-6 border-b border-green-500">
      ...
      <div className="grid gap-4 mb-6 md:grid-cols-2 mt-5">
        <div>
          <label
            htmlFor="first_name"
            className="block mb-2 text-base md:text-xl font-medium text-gray-900 dark:text-white"
          >
            Nom
          </label>
          <input
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className="bg-gray-50 border border-gray-300 text-gray-900 text-base md:text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Doe"
            required
          />
        </div>
